...
public enum HotelPolicyType
{
    ...
    NoCancellationAllowed = 2,
    PetsAllowed = 3,
    NoPetsAllowed = 4,
    SmokingAllowed = 5,
    NoSmokingAllowed = 6,
    BreakfastIncluded = 7,
    NoBreakfastIncluded = 8,
    FreeCancellationAllowed = 9,
    PaidCancellationAllowed = 10,
    FreeWiFiAvailable = 11,
    PaidWiFiAvailable = 12,
    ParkingAvailable = 13,
    AirportTransferAvailable = 14,
    LaundryServiceAvailable = 15,
    RoomServiceAvailable = 16,
    MiniBarAvailable = 17,
    GymAvailable = 18,
    SpaAvailable = 19,
    PoolAvailable = 20,
    MeetingRoomsAvailable = 21,
    RestaurantAvailable = 22,
    BarAvailable = 23,
    TwentyFourHourFrontDesk = 24,
    BusinessCenterAvailable = 25,
    ChildCareServicesAvailable = 26,
    ConciergeServiceAvailable = 27,
    CurrencyExchangeAvailable = 28,
    DisabilityAccessible = 29,
    ExpressCheckIn = 30,
    ExpressCheckOut = 31,
    IndoorPoolAvailable = 32,
    OutdoorPoolAvailable = 33,
    SaunaAvailable = 34,
    JacuzziAvailable = 35,
    TerraceAvailable = 36,
    GardenAvailable = 37,
    BeachAccessAvailable = 38,
    TennisCourtsAvailable = 39,
    GolfCourseAvailable = 40,
    BikeRentalAvailable = 41,
    CarRentalAvailable = 42,
    ShuttleServiceAvailable = 43,
    BabysittingServicesAvailable = 44,
    LibraryAvailable = 45,
    GameRoomAvailable = 46,
    MovieTheaterAvailable = 47,
    LiveEntertainmentAvailable = 48,
    KaraokeAvailable = 49,
    DanceFloorAvailable = 50,
    IndoorSportsFacilitiesAvailable = 51,
    OutdoorSportsFacilitiesAvailable = 52,
    PetFriendlyRoomsAvailable = 53,
    ChildFriendlyFacilities = 54,
    EcoFriendlyPolicies = 55,
    AllInclusivePackagesAvailable = 56,
    VeganMenuOptionsAvailable = 57,
    HalalMenuOptionsAvailable = 58,
    KosherMenuOptionsAvailable = 59,
    OrganicFoodOptionsAvailable = 60
}

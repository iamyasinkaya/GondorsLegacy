...
/// <summary>
/// Otel hizmetlerini ve özelliklerini temsil eden enum.
/// </summary>
...
//    public static HotelServiceType DesignatedSmokingArea { get; } = new HotelServiceType(65, "Belirlenen Sigara İçme Alanı");
...
//    public static HotelServiceType PetReflector { get; } = new HotelServiceType(88, "Evcil Hayvan Gezdirme Reflektörler");
//    public static HotelServiceType PetEquipment { get; } = new HotelServiceType(89, "Evcil Hayvan Gezdirme Ekipmanları");
//    public static HotelServiceType PetNecklace { get; } = new HotelServiceType(90, "Evcil Hayvan Gezdirme Yaka");
//    public static HotelServiceType PetDogHarness { get; } = new HotelServiceType(91, "Evcil Hayvan Gezdirme Köpek Harnası");
//    public static HotelServiceType PetCatLeash { get; } = new HotelServiceType(92, "Evcil Hayvan Gezdirme Kedi Tasma");
//    public static HotelServiceType PetBackpack { get; } = new HotelServiceType(93, "Evcil Hayvan Gezdirme Sırt Çantası");
//    public static HotelServiceType PetMat { get; } = new HotelServiceType(94, "Evcil Hayvan Gezdirme Pet Minderi");
//    public static HotelServiceType PetCollarCamera { get; } = new HotelServiceType(95, "Evcil Hayvan Gezdirme Yaka Kamera");
...
public enum HotelServiceType
{
    ...
    HorseRiding = 39,
    SkiInSkiOut = 40,
    WaterSportEquipment = 41,
    YogaClasses = 42,
    BeautySalon = 43,
    MedicalAssistance = 44,
    Ballroom = 45,
    GiftShop = 46,
    Chapel = 47,
    WeddingServices = 48,
    ...
    SunTerrace = 59,
    BBQFacilities = 60,
    SharedLoungeTVArea = 61,
    TwentyFourHourSecurity = 62,
    BicycleParking = 63,
    PicnicArea = 64,
    DesignatedSmokingArea = 65,
    FirstAidKit = 66,
    FireExtinguishers = 67,
    SecurityAlarm = 68,
    CCTVSecurity = 69,
    SmokeAlarms = 70,
    KeyCardAccess = 71,
    WheelchairAccess = 72,
    AssistanceForDisabled = 73,
    SoundproofRooms = 74,
    AirConditioning = 75,
    Heating = 76,
    FamilyRooms = 77,
